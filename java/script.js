    ...
    fetch("https://covid-193.p.rapidapi.com/statistics", {
        ...
        .then(response => {
            ...
            for (let data in getResult) {
                ...
                let newCase = format.format(getResult[data].cases.new);
                let ratio = population / confirmCase;
                let result = ((parseInt(newCase)) / population) * 100000;
                ...
                if (Math.round(ratio) > 0 && Math.round(ratio) <= 20) {
                    ...
                    if (i !== -1) {
                        ...
                        if (element !== null) {
                            element.style.fill = 'rgb(121,0,25)';
                        }
                    }
                }
                if (Math.round(ratio) > 20 && Math.round(ratio) <= 60) {
                    ...
                    if (i !== -1) {
                        let element = document.getElementById(countryName[i].code);
                        if (element !== null) {
                            element.style.fill = 'rgb(217,0,44)';
                        }
                    }
                }
                if (Math.round(ratio) > 60 && Math.round(ratio) <= 120) {
                    ...
                    if (i !== -1) {
                        let element = document.getElementById(countryName[i].code);
                        if (element !== null) {
                            element.style.fill = 'rgb(255,150,0)';
                        }
                    }
                }
                if (Math.round(ratio) > 120 && Math.round(ratio) <= 200) {
                    ...
                    if (i !== -1) {
                        let element = document.getElementById(countryName[i].code);
                        if (element !== null) {
                            element.style.fill = 'rgb(255,201,0)';
                        }
                    }
                }
                if (Math.round(ratio) > 200 && Math.round(ratio) <= 300) {
                    ...
                    if (i !== -1) {
                        let element = document.getElementById(countryName[i].code);
                        if (element !== null) {
                            element.style.fill = 'rgb(239,228,176)';
                        }
                    }
                }
